...
GPU="${GPU:-0}"      # CUDA device index (Blackwell sm_100/sm_120); override with --gpu
N2=140
N1=40
...
# offline by default (a timing harness shouldn't hit the network); OFFLINE=0 opts out
# for machines without cached assets.
[[ "${OFFLINE:-1}" != "0" ]] && export HF_HUB_OFFLINE=1 TRANSFORMERS_OFFLINE=1
