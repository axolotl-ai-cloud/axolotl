...
packed into a single sequence to maximize GPU utilization. (Multimodal sample packing is not supported with streaming — it requires a prepared dataset; see [Multipack](multipack.qmd).)
