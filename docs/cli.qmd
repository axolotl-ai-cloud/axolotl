...
Axolotl supports remote training through Modal, Baseten, and installed cloud launcher plugins.
...
The cloud YAML's `provider` selects the launcher: `modal` (the default), `baseten`,
...
unsupported operations explicitly. Baseten currently supports training only. Set training overrides directly in the
