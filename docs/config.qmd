...
qat:
  ...
  quantize_with_ptq: # Optional[bool] = False. Whether to save the quantized model. If false, weights must be quantized after training has completed using the ``quantize`` CLI.
