...
# See: `src/axolotl/monkeypatch/loss/chunked.py`
chunked_cross_entropy:  # Optional[bool]. Whether to use chunked cross entropy.
chunked_cross_entropy_num_chunks:  # Optional[int] = 8. Number of chunks to use for chunked cross entropy.
