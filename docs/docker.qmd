...
2.13.0 and 2.14.0+. The floating `main-latest` tags point at the Python 3.12 /
CUDA 13.0 / PyTorch 2.13.0 build. Bare release tags, such as `0.16.1`, point
...
- `main-base-py3.12-cu130-2.13.0`
- `main-base-py3.12-cu130-2.14.0`
...
- `main-py3.12-cu130-2.13.0`
- `main-py3.12-cu130-2.14.0`
- `main-latest`
- `main-20260924-py3.12-cu130-2.13.0`
- `0.18.0`
- `0.18.0-py3.12-cu130-2.13.0`
- `0.18.0-latest`
