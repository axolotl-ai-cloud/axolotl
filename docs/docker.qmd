...
2.11.0 and 2.12.1+. The floating `main-latest` tags point at the Python 3.12 /
CUDA 13.0 / PyTorch 2.12.1 build. Bare release tags, such as `0.16.1`, point
...
- `main-py3.12-cu130-2.12.1`
- `main-latest`
- `main-20260315-py3.12-cu130-2.12.1`
- `0.16.1`
- `0.16.1-py3.12-cu130-2.12.1`
- `0.16.1-latest`
