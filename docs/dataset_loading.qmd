...
Tigris uses a single global endpoint and doesn't charge egress fees. Useful when the same dataset is re-read across epochs or by workers in multiple regions.
