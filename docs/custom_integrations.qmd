...
Adding new plugins allows hooking to multiple parts of the training pipeline for custom features.

::: {.callout-note}

See `BasePlugin` at [src/axolotl/integrations/base.py](https://github.com/axolotl-ai-cloud/axolotl/blob/main/src/axolotl/integrations/base.py) for the possible hooks.
...
See [src/axolotl/integrations/cut_cross_entropy](https://github.com/axolotl-ai-cloud/axolotl/tree/main/src/axolotl/integrations/cut_cross_entropy) for an example of a minimal integration.
