...
Memory-efficient drop-in replacement for AdamW that cuts optimizer-state memory
by roughly 8x.

GitHub: [https://github.com/ndvbd/Gefen](https://github.com/ndvbd/Gefen)
Paper: [https://arxiv.org/abs/2606.13894](https://arxiv.org/abs/2606.13894)

Install: `pip install gefen`
