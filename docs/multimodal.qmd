...
# (optional) Qwen2/2.5/3-VL, Qwen3.5, Omni, GLM-4V and GLM-OCR run the vision
# patch_embed Conv3d as an equivalent, faster GEMM by default; set false to
# keep the stock Conv3d forward. See Optimizations docs.
# vision_patch_embed_linear: false
```
