...
- [North Micro Vision](#sec-north-micro-vision) *(NEW)*
...
### North Micro Vision {#sec-north-micro-vision}

Axolotl now supports [CohereCompass](https://github.com/axolotl-ai-cloud/axolotl/tree/main/examples/cohere-compass), the architecture behind Cohere Labs' North Micro Vision.
...
Requires `transformers>=5.15.0`. Keep `sample_packing: false` for image data. Cut Cross Entropy is supported and recommended. See the [example configs and tips](https://github.com/axolotl-ai-cloud/axolotl/tree/main/examples/cohere-compass) for details.
