...
Keep `sample_packing: false` and do not enable Liger or Cut Cross Entropy. See the [example configs and tips](https://github.com/axolotl-ai-cloud/axolotl/tree/main/examples/paddleocr-vl) for details.
