...
class AxolotlInputConfig(
    ...
    dpo_use_weighting: bool | None = Field(
        default=None,
        json_schema_extra={
            "description": "Whether to perform weighting in DPO trainer. If `None`, default is `False` in the trainer."
        },
    )
    ...
    random_init_weights: bool | None = Field(
        default=None,
        json_schema_extra={
            "description": "Whether to load the model with randomly initialized weights. Useful for pre-training a model from scratch or debugging purposes."
        },
    )
    debug: bool | None = Field(
        default=None,
        json_schema_extra={
            "description": "Whether to print debugging information to the command line."
        },
    )
