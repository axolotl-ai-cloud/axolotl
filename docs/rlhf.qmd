...
As IPO is just DPO with a different loss function, all supported dataset formats for [DPO](#dpo) works.
...
```yaml
rl: simpo
rl_beta: 2.5  # default is 0.1 in CPOTrainer
cpo_alpha: 0.05  # default is 1.0 in CPOTrainer
simpo_gamma: 0.1  # default is 0.5 in CPOTrainer
```
