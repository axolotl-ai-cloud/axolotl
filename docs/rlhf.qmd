...
The various RL training methods are implemented in trl and wrapped via axolotl. Each method has their own supported ways of loading datasets and prompt format.
