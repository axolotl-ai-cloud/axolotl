...
Watch `scope/temperature` and `scope/positive_frac`: a `positive_frac` pinned at 0 means `scope_positive_threshold` is above what your reward functions actually emit, and the branch contributes nothing.
