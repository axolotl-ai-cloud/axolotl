...
- To swap to Full finetuning, remove these two lines.
- To swap to QLoRA finetuning, replace with `load_in_4bit: true` and `adapter: qlora`.
:::
...
2. (If specified) applies q/LoRA adapter layers
