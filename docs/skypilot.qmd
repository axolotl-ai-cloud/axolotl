...
For direct Nebius Serverless Jobs through `axolotl train --cloud`, see the
[Nebius Serverless guide](nebius-serverless.qmd).
...
run: |
  ...
  axolotl train /workspace/axolotl/examples/gpt-oss/gpt-oss-20b-fft-fsdp2.yaml --launcher torchrun -- \
