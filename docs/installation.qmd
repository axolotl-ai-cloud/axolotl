...
::: {.callout-important}
For Blackwell GPUs, please use Pytorch 2.9.1 and CUDA 13.0. CUDA 12.8 cannot
...
::: {.callout-important}
For Blackwell GPUs, please use `axolotlai/axolotl-uv:main-py3.11-cu130-2.9.1` or the cloud variant `axolotlai/axolotl-cloud-uv:main-py3.11-cu130-2.9.1`.
:::
