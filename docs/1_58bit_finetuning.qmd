...
::: {.callout-note}
This page covers finetuning checkpoints that are *already* ternary. To convert a
full-precision model to 1.58-bit yourself, see
[Ternary Conversion](ternary_conversion.qmd) — the two paths are mutually exclusive.
:::
