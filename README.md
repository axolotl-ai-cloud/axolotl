...
- 2025/03: Muon optimizer support has been added to Axolotl. Simply update your config with `optimizer: muon` to get started more sample efficient fine-tuning!
