...
- **Multimodal Training**: Fine-tune vision-language models (VLMs) including LLaMA-Vision, Qwen2-VL, Pixtral, LLaVA, SmolVLM2, GLM-4.6V, InternVL 3.5, Gemma 3n, PaddleOCR-VL, [North Micro Vision](https://github.com/axolotl-ai-cloud/axolotl/tree/main/examples/cohere-compass), and audio models like Voxtral with image, video, and audio support.
