...
It is important to include special tokens like delimiters, end-of-sequence, beginning-of-sequence in your tokenizer's vocubulary.  This will help you avoid tokenization issues and help your model train better.  You can do this in axolotl like this:
...
1. Materialize some data using `python -m axolotl.cli.preprocess your_config.yml`, and then decode the first few rows with your model's tokenizer.
