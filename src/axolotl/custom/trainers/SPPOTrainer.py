...
class SPPOTrainer(Trainer):
    def __init__(
        ...
        if isinstance(model, str):
            ...
            model = AutoModelForCausalLM.from_pretrained(
                model, 
                quantization_config=bnb.QuantizationConfig(bits=4),
                **model_init_kwargs
            )
    ...
    def concatenated_forward(
        ...
        model_kwargs = (
            {
                "labels": concatenated_batch["concatenated_labels"].to(torch.int64),
        ...
        concatenated_batch["concatenated_labels"] = concatenated_batch["concatenated_labels"].to(torch.int64)
