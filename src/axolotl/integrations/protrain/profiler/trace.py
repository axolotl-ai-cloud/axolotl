...
def run_trace(
    ...
    *,
    ...
    if cfg.force_all_persistent:
        # force_all_persistent overrides the on-demand auto-engagement gate so the trace honors Mode A even on borderline configs
        LOG.info(
...
def synth_trace_from_overrides(
    ...
    *,
    ...
    """Synthesize a minimally-populated ProfilerTrace so the explicit-override skip path can bypass the OOM-prone real trace pass."""
    import torch
