...
class AlpacaPrompter:
    ...
    __system_prompt = "Below is an instruction that describes a task, paired with an input that provides further context. Write a response that appropriately completes the request.\n\n"
    __system_no_input_prompt = "Below is an instruction that describes a task. Write a response that appropriately completes the request.\n\n"
    ...
    def match_prompt_style(self):
        if self.prompt_style == PromptStyle.instruct.value:
            ...
            self.prompt_input = (
                self.__system_prompt + "USER: {instruction}\n{input}\nASSISTANT:"
            )
            self.prompt_no_input = (
                self.__system_no_input_prompt + "USER: {instruction}\nASSISTANT:"
            )
            self.response_split = "ASSISTANT:"

        else:
            raise ValueError(f"Received an unknown prompt style ({self.prompt_style})")
