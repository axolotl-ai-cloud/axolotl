...
def load_model(
    ...
    if cfg.is_llama_derived_model and cfg.noisy_embedding_alpha:
        ...
        replace_llama_embeddings_with_uniform_distribution(noise_alpha=cfg.noisy_embedding_alpha)
    ...
    if cfg.is_mistral_derived_model and cfg.noisy_embedding_alpha:
        ...
        LOG.info("patching with noisy embeddings")
        replace_mistral_embeddings_with_uniform_distribution(noise_alpha=cfg.noisy_embedding_alpha)
