    ...
    def _generate_and_score_completions(
        ...
        if self.args.use_vllm:
            ...
            if self.accelerator.is_main_process:
                ...
                # prompt individually.
                ordered_set_of_prompts = all_prompts_text[:: self.num_generations * self.args.sequence_parallel_degree]
                with profiling_context(self, "vLLM.generate"):
                    ...
                    print(f"{dist.get_rank()}: completion_ids.shape: {completion_ids.shape}")
            else:
