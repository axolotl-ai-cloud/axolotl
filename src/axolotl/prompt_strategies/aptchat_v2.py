...
class PygmalionPromptTokenizingStrategy(PromptTokenizingStrategy):
    ...
    def __init__(self, prompter, tokenizer, *args, **kwargs):
        ...
        self.tokenizer_bos_token = tokenizer.bos_token
        self.tokenizer_eos_token = tokenizer.eos_token
    ...
    def tokenize_prompt(self, prompt):
        ...
        for _, part in enumerate(self.prompter.build_prompt(prompt["conversations"])):
            ...
            if role == "system":
                ...
                res = self._tokenize(
                    prefix + "\n " + message.strip() + self.tokenizer_eos_token + "\n",
                    add_eos_token=False,
                ...
                # everything from this is masked out from the labels
                labels = [IGNORE_TOKEN_ID] * len(res["input_ids"])
            elif role == "assistant" or role == "gpt" or role == "bot":
