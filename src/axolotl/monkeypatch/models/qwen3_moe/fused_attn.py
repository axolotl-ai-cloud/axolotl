"""Qwen3-MoE variant of the qwen3 fused-attention monkeypatch."""
...
def patch_qwen3_moe_fused_attn() -> None:
    from transformers.models.qwen3_moe.modeling_qwen3_moe import Qwen3MoeAttention

    if getattr(Qwen3MoeAttention, "_axolotl_fused_attn_patched", False):
        return

    Qwen3MoeAttention.forward = _make_fused_forward()
    Qwen3MoeAttention._axolotl_fused_attn_patched = True
    logger.info(
        "Patched Qwen3MoeAttention.forward with fused RMSNorm+RoPE Triton kernel"
    )
