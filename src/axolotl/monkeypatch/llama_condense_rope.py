# pylint: skip-file
"""
Condensing rotary embeddings for LLAMA.

Adapted from https://github.com/DachengLi1/LongChat/blob/longeval/longchat/train/monkey_patch/llama_condense_monkey_patch.py
"""
...
class CondenseRotaryEmbedding(torch.nn.Module):
    """
    CondenseRotaryEmbedding to scale the positional embeddings for LLAMA.
    """
