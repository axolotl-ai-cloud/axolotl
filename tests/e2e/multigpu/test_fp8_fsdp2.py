...
from tests.e2e.utils import most_recent_subdir, require_torch_2_4_1
...
class TestFP8FSDP2:
    ...
    @require_torch_2_4_1
    def test_fp8_fsdp2_lora_smoke(self, temp_dir):
        """Smoke test for 2-GPU FP8 + torch.compile + FSDP2 + LoRA training"""
        cfg = DictDefault(
            {
                "base_model": "HuggingFaceTB/SmolLM2-135M",
                "tokenizer_type": "AutoTokenizer",
