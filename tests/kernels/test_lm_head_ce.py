...
from axolotl.kernels.lm_head_ce import (
...
def _restore_vocab_block():
    """The bf16/fp8 kernels keep _VOCAB_BLOCK as a module global; snapshot and
    restore it so vocab-block tests don't leak state across tests."""
    import axolotl.kernels.bf16_fused_ce as bf16_ce
    import axolotl.kernels.fp8_fused_ce as fp8_ce

    saved = (bf16_ce._VOCAB_BLOCK, fp8_ce._VOCAB_BLOCK)
    yield
    bf16_ce._VOCAB_BLOCK, fp8_ce._VOCAB_BLOCK = saved
